...
const ProductPage = () => {
    ...
    const product = {
        ...
        image: imageUrl,
        images: route.params?.product?.images?.length > 0 ? route.params.product.images : [imageUrl, imageUrl, imageUrl],
    ...
    return (
        <View style={styles.container}>
            <ScrollView>
                <ScrollView horizontal={false} style={styles.imageScroll}>
...
const styles = StyleSheet.create({
    ...
    imageScroll: { paddingTop: 10, height: 300, backgroundColor: '#eee' },
    ...
    salePrice: { fontSize: 16, fontWeight: 'bold', color: '#000000', marginTop: 5 },
    ...
    priceContainer: { flexDirection: "row", justifyContent: "space-between", padding: 10, borderBottomWidth: 1, borderTopWidth: 1, borderColor: "#000", backgroundColor: "#fff",  },
