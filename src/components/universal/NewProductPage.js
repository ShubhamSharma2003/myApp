...
const ProductPage = () => {
    ...
    const onPageScroll = (e) => {
        ...
        setScrollPosition(yOffset); // Update the scroll position
    };
...
const styles = StyleSheet.create({
    ...
    imageScroll: { paddingTop: 10, height: 400, backgroundColor: '#fff' },
    ...
    variantScroll: { padding: 5,paddingBottom: 10, paddingHorizontal: 16, flexDirection: "row", backgroundColor: '#eee', },
    variantButton: { paddingRight: 30, overflow: "hidden" },
    variantImage: { width: 80, height: 80, resizeMode: "cover" },
    deliveryContainer: { padding: 20, backgroundColor:'#fff' },
    deliveryText: { fontSize: 16, fontWeight: "bold", marginBottom: 5 },
    shippingContainer: { padding: 20, flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor:'#fff', padding: 15, borderWidth: 1, borderColor: "#EEE" },
    ...
    featureCard: { alignItems: "center", width: "30%", padding: 10, backgroundColor: "#eee", marginVertical: 5 },
